/**
 * 車載機との接続性が悪い場合
 * DL後にdisconnect→connect→disconnect
 */
var MapDownloadSenarioDisconnectAfterDownload = (function () {

    function MapDownloadSenarioDisconnectAfterDownload() {
        this.queue = [];
    }

    MapDownloadSenarioManager.MapDownloadSenarioDisconnectAfterDownload = MapDownloadSenarioDisconnectAfterDownload;

    MapDownloadSenarioDisconnectAfterDownload.prototype.start = function () {
    ...
    return MapDownloadSenarioDisconnectAfterDownload;
})();