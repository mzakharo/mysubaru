 ...
 * オセアニア
 * 800(Western Australia), 803(Queensland), 808(New Zealand)
 */
var MapDownloadSenario_DL_Transfer_Map_Oceania = (function () {

    function MapDownloadSenario_DL_Transfer_Map_Oceania() {
        this.queue = [];
        this.setDonloaded([800]);
    }

    MapDownloadSenarioManager.MapDownloadSenario_DL_Transfer_Map_Oceania = MapDownloadSenario_DL_Transfer_Map_Oceania;

    MapDownloadSenario_DL_Transfer_Map_Oceania.prototype.setDonloaded = function (regionIDList) {
        try {
    ...
    MapDownloadSenario_DL_Transfer_Map_Oceania.prototype.start = function () {

        var regionIDList = [800, 803, 808];
    ...
    return MapDownloadSenario_DL_Transfer_Map_Oceania;
})();