/**
 * 異常：DL途中でネットワークが切れた場合
 * シナリオ001を参考に作成しています。
 */
var MapDownloadSenario004 = (function () {

    function MapDownloadSenario004() {
        this.queue = [];
    }

    MapDownloadSenarioManager.MapDownloadSenario004 = MapDownloadSenario004;

    MapDownloadSenario004.prototype.start = function () {
        ...
        queue.push({
            ...
            "data": [
                {
                    "deviceCode": "891167361",
                    "status": 12,  //DownloadFailNetworkError
                    "toVersion": 3,
                    "productCode": "3122895924",
                    // "regionID": 452,
                    "regionID": 304,
