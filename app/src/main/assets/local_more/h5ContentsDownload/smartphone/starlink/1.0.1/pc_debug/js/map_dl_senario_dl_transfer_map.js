 ...
 */
var MapDownloadSenarioDL_Transfer_Map = (function () {

    function MapDownloadSenarioDL_Transfer_Map() {
        this.queue = [];
        this.setDonloaded([]);
    }

    MapDownloadSenarioManager.MapDownloadSenarioDL_Transfer_Map = MapDownloadSenarioDL_Transfer_Map;

    MapDownloadSenarioDL_Transfer_Map.prototype.setDonloaded = function (regionIDList) {
        try {
    ...
    MapDownloadSenarioDL_Transfer_Map.prototype.start = function () {
    ...
    return MapDownloadSenarioDL_Transfer_Map;
})();