...
import com.subaru.global.infotainment.gen2.extend.storage.GetStorageInfoModule;
...
public class GetStorageInfoModuleFactory implements MSHTTPModuleFactory {
    ...
    public MSModuleDelegate create() {
        ...
        return new GetStorageInfoModule();
    }
}
